...
<div class="tab-products single-products section-padding extra-padding-top" style="background-color: #f9f9f9;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="section-title text-center">
                    <div class="product-tab nav nav-tabs">
                        <ul>
                            <li class="active"><a data-toggle="tab" href="#arrival" style="color: #333;">Thực phẩm & Đồ uống <span>/</span></a></li>
                            <li><a data-toggle="tab" href="#popular" style="color: #333;">Thời trang & Phụ kiện<span>/</span></a></li>
                            <li><a data-toggle="tab" href="#best" style="color: #333;">Điện tử & Công nghệ<span>/</span></a></li>                            
                            <li><a data-toggle="tab" href="#best2" style="color: #333;">Đồ gia dụng & Nội thất<span>/</span></a></li>
                            <li><a data-toggle="tab" href="#best3" style="color: #333;">Sách & Văn phòng phẩm</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center tab-content">
            <div class="tab-pane fade in active" id="arrival">
                <div class="wrapper">
                            ...
                            for ($i = $r*4; $i < (count($data_sanpham1)-4)*$r+4; $i++) {
                                ?>
                                    <div class="col-xs-12 col-sm-6 col-md-3 r-margin-top">
                                        <div class="single-product" style="border: 1px solid #ddd; padding: 10px;">
                                            <div class="product-f">
                                                <a href="?act=detail&id=<?= $data_sanpham1[$i]['MaSP'] ?>"><img src="public/<?= $data_sanpham1[$i]['HinhAnh'] ?>" alt="Product Title" class="img-products" style="max-width: 100%; height: auto;" /></a>
                    ...
                    <button id="load-more-two" style="background-color: #333; color: #fff;">Tải thêm</button>
                </div>
            </div>
            <!-- arrival product end -->
            <div class="tab-pane fade" id="popular">
                <div class="wrapper">
                            ...
                            for ($i = $r*4; $i < (count($data_sanpham2)-4)*$r+4; $i++) {
                                ?>
                                    <div class="col-xs-12 col-sm-6 col-md-3 r-margin-top">
                                        <div class="single-product" style="border: 1px solid #ddd; padding: 10px;">
                                            <div class="product-f">
                                                <a href="?act=detail&id=<?= $data_sanpham2[$i]['MaSP'] ?>"><img src="public/<?= $data_sanpham2[$i]['HinhAnh'] ?>" alt="Product Title" class="img-products" style="max-width: 100%; height: auto;" /></a>
                                                <div class="actions-btn">
                    ...
                    <button id="load-more-three" style="background-color: #333; color: #fff;">Tải thêm</button>
                </div>
            </div>
            <!-- popular product end -->
            <div class="tab-pane fade" id="best">
                <div class="wrapper">
                            ...
                            for ($i = $r*4; $i < (count($data_sanpham3)-4)*$r+4; $i++) {
                                ?>
                                    <div class="col-xs-12 col-sm-6 col-md-3 r-margin-top">
                                        <div class="single-product" style="border: 1px solid #ddd; padding: 10px;">
                                            <div class="product-f">
                                                <a href="?act=detail&id=<?= $data_sanpham3[$i]['MaSP'] ?>"><img src="public/<?= $data_sanpham3[$i]['HinhAnh'] ?>" alt="Product Title" class="img-products" style="max-width: 100%; height: auto;" /></a>
                                                <div class="actions-btn">
                    ...
                    <button id="load-more-four" style="background-color: #333; color: #fff;">Tải thêm</button>
                </div>
            </div>
            <!-- best product end -->
            <div class="tab-pane fade" id="best2">
                <div class="wrapper">
                            ...
                            for ($i = $r*4; $i < (count($data_sanpham4)-4)*$r+4; $i++) {
                                ?>
                                    <div class="col-xs-12 col-sm-6 col-md-3 r-margin-top">
                                        <div class="single-product" style="border: 1px solid #ddd; padding: 10px;">
                                            <div class="product-f">
                                                <a href="?act=detail&id=<?= $data_sanpham4[$i]['MaSP'] ?>"><img src="public/<?= $data_sanpham4[$i]['HinhAnh'] ?>" alt="Product Title" class="img-products" style="max-width: 100%; height: auto;" /></a>
                                                <div class="actions-btn">
                    ...
                    <button id="load-more-five" style="background-color: #333; color: #fff;">Tải thêm</button>
                </div>
            </div>
            <!-- best2 product end -->
            <div class="tab-pane fade" id="best3">
                <div class="wrapper">
                            ...
                            for ($i = $r*4; $i < (count($data_sanpham5)-4)*$r+4; $i++) {
                                ?>
                                    <div class="col-xs-12 col-sm-6 col-md-3 r-margin-top">
                                        <div class="single-product" style="border: 1px solid #ddd; padding: 10px;">
                                            <div class="product-f">
                                                <a href="?act=detail&id=<?= $data_sanpham5[$i]['MaSP'] ?>"><img src="public/<?= $data_sanpham5[$i]['HinhAnh'] ?>" alt="Product Title" class="img-products" style="max-width: 100%; height: auto;" /></a>
                                                <div class="actions-btn">
                    ...
                    <button id="load-more-six" style="background-color: #333; color: #fff;">Tải thêm</button>
                </div>
            </div>
            <!-- best3 product end -->
        </div>
...
<section class="collection-area collection-area2 section-padding" style="background-color: #f1f1f1;">
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <div class="single-colect banner collect-one" style="border: 1px solid #ddd;">
                    <a href="?act=detail&id=<?= $data_random['0']['MaSP'] ?>"><img src="public/<?= $data_random['0']['HinhAnh'] ?>" alt="" style="max-width: 100%; height: auto;" /></a>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="colect-text " style="padding: 10px;">
            ...
            <div class="col-sm-4">
                <div class="collect-img banner single-colect" style="border: 1px solid #ddd;">
                    <a href="?act=detail&id=<?= $data_random['1']['MaSP'] ?>"><img src="public/<?= $data_random['1']['HinhAnh'] ?>" alt="" style="max-width: 100%; height: auto;" /></a>
                </div>
                <div class="colect-text " style="padding: 10px;">
...
<section class="single-products  products-two section-padding extra-padding-bottom" style="background-color: #f9f9f9;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="section-title text-center">
        ...
        <div class="wrapper">
                            ...
                            if ($data_arr[$i] != null) {
                                foreach ($data_arr[$i] as  $row) { ?>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 r-margin-top">
                                        <div class="single-product" style="border: 1px solid #ddd; padding: 10px;">
                                            <div class="product-f">
                                                <a href="?act=detail&id=<?= $row['MaSP'] ?>"><img src="public/<?= $row['HinhAnh'] ?>" alt="Product Title" class="img-products" style="max-width: 100%; height: auto;" /></a>
                                                <div class="actions-btn">
            ...
            <button id="load-more-one" style="background-color: #333; color: #fff;">Tải thêm</button>
        </div>
    </div>
</section>
